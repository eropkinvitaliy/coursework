...
<div class="auth-item-index">
    ...
    <p>
        <?= Html::a('Добавить новую группу', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <div id="w0" class="grid-view">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <th style="width: 5%"> №</th>
                <th style="width: 15%">Название группы</th>
                <th style="width: 15%">Описание группы</th>
                <th style="width: 8%">&nbsp;</th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr data-key=<?= $item->name; ?>>
                    ...
                    <td>
                        <?php if ($item->name !== 'admin'): ?>
                            <a href="view?type=<?= $item->type; ?>&id=<?= $item->name; ?>" title="Просмотр"
                               aria-label="Просмотр"
                               data-pjax="0">
                                <span class="glyphicon glyphicon-eye-open"></span></a>

                            <a href="update?id=<?= $item->name; ?>" title="Редактировать"
